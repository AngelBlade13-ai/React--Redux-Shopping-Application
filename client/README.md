...
3. Optional product seed from FakeStore API:
```bash
...
1. Added 3 new products to the shopping site
...
2. Included a new site title
- Store branding/title was updated to **NextHaul**.

3. Added a Contact page
...
6. README includes setup + run process
